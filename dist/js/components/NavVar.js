                ...
                <form class="d-flex" role="search" action="search.html" method="GET">
                    <div class="dropdown m-auto">
                        ...
                        <ul class="dropdown-menu fs-4">
                            <li v-for="category in categories" :key="category" class="dropdown-item">{{ category }}</li>
                        </ul>
                    </div>
                    <input class="form-control me-2 search-bar fs-4" type="search" name="searchString" placeholder="Buscar"
                        aria-label="Search">
